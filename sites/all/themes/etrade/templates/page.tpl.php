 ...
 */
?>
<header id="navbar" role="banner" class="navbar navbar-default<?php /*print $navbar_classes;*/ ?>">
  <div class="container">
...
<div class="main-white-header">
  ...
  <div class="container">
    ...
    if(isset($title_explode[1])) {
      $title_explode = explode(' ', $title,2);?><h1 class="page-header"><span class='red-text'><?php print $title_explode[0]; ?></span><?php print $title_explode[1];?>
      </h1><?php
    }
    else { 
